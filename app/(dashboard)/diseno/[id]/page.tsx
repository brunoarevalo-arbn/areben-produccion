...
export default async function ProyectoPage({
  ...
  const [raw, usuariosRaw] = await Promise.all([
  ...
  const proyecto: ProyectoDiseno = {
    ...
    molderiaFormato:  raw.molderiaFormato,
    tela:             raw.tela,
    costo:            raw.costo,
    ...
    pasos: raw.pasos.map((p) => ({
      ...
      esTercero:            p.esTercero,
      terceroNombre:        p.terceroNombre,
      responsableInternoId: p.responsableInternoId,
  ...
  return (
    <div className="min-h-screen">
      ...
      <ProyectoView proyecto={proyecto} usuarios={usuariosRaw} />
    </div>
  );
}

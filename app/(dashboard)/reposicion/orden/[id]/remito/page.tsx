  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <div className="flex items-center justify-between mb-6 print:hidden">
        <h1 className="text-lg font-bold text-stone-800">Remito de estampa</h1>
        <PrintButton />
      </div>
      ...
      <div className="bg-white rounded-xl border border-stone-200 p-8 print:border-0 print:p-0">
        <div className="flex items-start justify-between border-b border-stone-200 pb-4 mb-4">
          <div>
            <p className="text-xs uppercase tracking-widest text-stone-400 font-bold">Areben · Remito de estampa</p>
        ...
        {items.length === 0 ? (
          ...
          <div key={liso} className="mb-5">
            <p className="font-mono text-xs text-stone-500 mb-1">Liso base: {liso}</p>
            <table className="w-full text-sm border border-stone-200">
              <thead><tr className="bg-stone-50 text-xs uppercase tracking-widest text-stone-500">
                <th className="text-left py-1.5 px-3 border-b border-stone-200">Estampado</th>

...
// Una prenda por partes (la bikini) manda un conteo POR PIEZA y cada uno entra a su
// propio SKU: el corte produce dos artículos que se venden por separado.
export async function POST(req: NextRequest, { params }: Ctx) {
  ...
  try {
    ...
    // Sólo el freno por falta de COSTO se puede levantar afirmándolo. El que falta un
    // dato del catálogo (el % de material de cada pieza, o su abreviatura de SKU) NO:
    // tildar una casilla no lo conseguiría, sólo congelaría un reparto inventado.
